...
export class WelcomeEmail implements IEmailTemplate<IWelcomeEmailData>{
    ...
    <tr>
        ...
        <div style="font-family: inherit; text-align: inherit"> <span
                style="color: #222222; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400">
                De parte del Equipo del Proyecto Docente Integrador, le damos la bienvenida al sistema digital del proyecto, 
                a través del cual, podrá dar seguimiento a las actividades propuestas en su Planificación, 
                como Docente Integrador del presente ciclo académico. Es importante recordar que, la Planificación 
                debe ser cargada como máximo, durante la primera semana de clases. <br> <br>
                Para dirigirse al Sistema Docente Integrador, ingrese en el botón a continuación, 
                en el cual deberá registrarse con su usuario y contraseña del correo institucional UTPL. </span> <br>
               <span
                style="color: #222222; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400">
        ...
        <div style="font-family: inherit; text-align: inherit"> <br> </div>
        <div> La información de este correo ha sido generada automáticamente por el Sistema del Proyecto Docente Integrador. Si
                tienes alguna duda, sugerencia o se presento algún incoveniente, puedes contactarte al correo electronico 
